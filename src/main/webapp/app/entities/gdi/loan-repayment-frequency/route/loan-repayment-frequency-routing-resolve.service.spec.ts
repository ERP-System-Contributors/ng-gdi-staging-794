...
describe('LoanRepaymentFrequency routing resolve service', () => {
  ...
  let resultLoanRepaymentFrequency: ILoanRepaymentFrequency | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultLoanRepaymentFrequency).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ILoanRepaymentFrequency>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
