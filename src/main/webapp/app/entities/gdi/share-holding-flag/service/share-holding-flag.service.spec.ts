...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../share-holding-flag.test-samples';

import { ShareHoldingFlagService } from './share-holding-flag.service';

const requireRestSample: IShareHoldingFlag = {
...
describe('ShareHoldingFlag Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a ShareHoldingFlag', () => {
      ...
      const shareHoldingFlag = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(shareHoldingFlag).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a ShareHoldingFlag', () => {
      const shareHoldingFlag = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(shareHoldingFlag).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addShareHoldingFlagToCollectionIfMissing', () => {
      it('should add a ShareHoldingFlag to an empty array', () => {
        const shareHoldingFlag: IShareHoldingFlag = sampleWithRequiredData;
      ...
      it("should add a ShareHoldingFlag to an array that doesn't contain it", () => {
        const shareHoldingFlag: IShareHoldingFlag = sampleWithRequiredData;
        const shareHoldingFlagCollection: IShareHoldingFlag[] = [sampleWithPartialData];
        expectedResult = service.addShareHoldingFlagToCollectionIfMissing(shareHoldingFlagCollection, shareHoldingFlag);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(shareHoldingFlag);
      });
      ...
      it('should add only unique ShareHoldingFlag to an array', () => {
        const shareHoldingFlagArray: IShareHoldingFlag[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const shareHoldingFlagCollection: IShareHoldingFlag[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const shareHoldingFlag: IShareHoldingFlag = sampleWithRequiredData;
        const shareHoldingFlag2: IShareHoldingFlag = sampleWithPartialData;
    ...
    describe('compareShareHoldingFlag', () => {
      it('Should return true if both entities are null', () => {
        const entity1 = null;
        const entity2 = null;

        const compareResult = service.compareShareHoldingFlag(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareShareHoldingFlag(entity1, entity2);
        const compareResult2 = service.compareShareHoldingFlag(entity2, entity1);
