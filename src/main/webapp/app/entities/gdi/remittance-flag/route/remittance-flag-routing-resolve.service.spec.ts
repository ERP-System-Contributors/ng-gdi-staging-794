...
describe('RemittanceFlag routing resolve service', () => {
  ...
  let resultRemittanceFlag: IRemittanceFlag | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultRemittanceFlag).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IRemittanceFlag>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
