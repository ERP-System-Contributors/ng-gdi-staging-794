...
describe('CreditCardOwnership routing resolve service', () => {
  ...
  let resultCreditCardOwnership: ICreditCardOwnership | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultCreditCardOwnership).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ICreditCardOwnership>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
