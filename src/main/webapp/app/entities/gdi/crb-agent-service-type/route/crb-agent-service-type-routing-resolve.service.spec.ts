...
describe('CrbAgentServiceType routing resolve service', () => {
  ...
  let resultCrbAgentServiceType: ICrbAgentServiceType | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultCrbAgentServiceType).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ICrbAgentServiceType>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
