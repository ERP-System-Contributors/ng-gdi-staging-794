...
describe('FxRateType routing resolve service', () => {
  ...
  let resultFxRateType: IFxRateType | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultFxRateType).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IFxRateType>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
