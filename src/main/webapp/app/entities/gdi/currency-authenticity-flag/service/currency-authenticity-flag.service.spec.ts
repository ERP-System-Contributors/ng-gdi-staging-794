...
import {
  ...
  sampleWithFullData,
} from '../currency-authenticity-flag.test-samples';

import { CurrencyAuthenticityFlagService } from './currency-authenticity-flag.service';

const requireRestSample: ICurrencyAuthenticityFlag = {
  ...sampleWithRequiredData,
};
...
describe('CurrencyAuthenticityFlag Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a CurrencyAuthenticityFlag', () => {
      ...
      const currencyAuthenticityFlag = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(currencyAuthenticityFlag).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a CurrencyAuthenticityFlag', () => {
      const currencyAuthenticityFlag = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(currencyAuthenticityFlag).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addCurrencyAuthenticityFlagToCollectionIfMissing', () => {
      it('should add a CurrencyAuthenticityFlag to an empty array', () => {
        const currencyAuthenticityFlag: ICurrencyAuthenticityFlag = sampleWithRequiredData;
      ...
      it("should add a CurrencyAuthenticityFlag to an array that doesn't contain it", () => {
        const currencyAuthenticityFlag: ICurrencyAuthenticityFlag = sampleWithRequiredData;
        const currencyAuthenticityFlagCollection: ICurrencyAuthenticityFlag[] = [sampleWithPartialData];
        expectedResult = service.addCurrencyAuthenticityFlagToCollectionIfMissing(
          currencyAuthenticityFlagCollection,
          currencyAuthenticityFlag
        );
      ...
      it('should add only unique CurrencyAuthenticityFlag to an array', () => {
        const currencyAuthenticityFlagArray: ICurrencyAuthenticityFlag[] = [
          sampleWithRequiredData,
          sampleWithPartialData,
          sampleWithFullData,
        ];
        const currencyAuthenticityFlagCollection: ICurrencyAuthenticityFlag[] = [sampleWithRequiredData];
        expectedResult = service.addCurrencyAuthenticityFlagToCollectionIfMissing(
          currencyAuthenticityFlagCollection,
      ...
      it('should accept varargs', () => {
        const currencyAuthenticityFlag: ICurrencyAuthenticityFlag = sampleWithRequiredData;
        const currencyAuthenticityFlag2: ICurrencyAuthenticityFlag = sampleWithPartialData;
    ...
    describe('compareCurrencyAuthenticityFlag', () => {
      it('Should return true if both entities are null', () => {
        const entity1 = null;
        const entity2 = null;

        const compareResult = service.compareCurrencyAuthenticityFlag(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareCurrencyAuthenticityFlag(entity1, entity2);
        const compareResult2 = service.compareCurrencyAuthenticityFlag(entity2, entity1);
