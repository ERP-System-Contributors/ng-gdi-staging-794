...
describe('SecurityTenure routing resolve service', () => {
  ...
  let resultSecurityTenure: ISecurityTenure | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultSecurityTenure).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ISecurityTenure>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
