...
import {
  ...
  sampleWithFullData,
} from '../gdi-master-data-index.test-samples';

import { GdiMasterDataIndexService } from './gdi-master-data-index.service';

const requireRestSample: IGdiMasterDataIndex = {
  ...sampleWithRequiredData,
};
...
describe('GdiMasterDataIndex Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a GdiMasterDataIndex', () => {
      ...
      const gdiMasterDataIndex = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(gdiMasterDataIndex).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a GdiMasterDataIndex', () => {
      const gdiMasterDataIndex = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(gdiMasterDataIndex).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addGdiMasterDataIndexToCollectionIfMissing', () => {
      it('should add a GdiMasterDataIndex to an empty array', () => {
        const gdiMasterDataIndex: IGdiMasterDataIndex = sampleWithRequiredData;
      ...
      it("should add a GdiMasterDataIndex to an array that doesn't contain it", () => {
        const gdiMasterDataIndex: IGdiMasterDataIndex = sampleWithRequiredData;
        const gdiMasterDataIndexCollection: IGdiMasterDataIndex[] = [sampleWithPartialData];
        expectedResult = service.addGdiMasterDataIndexToCollectionIfMissing(gdiMasterDataIndexCollection, gdiMasterDataIndex);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(gdiMasterDataIndex);
      });
      ...
      it('should add only unique GdiMasterDataIndex to an array', () => {
        const gdiMasterDataIndexArray: IGdiMasterDataIndex[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const gdiMasterDataIndexCollection: IGdiMasterDataIndex[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const gdiMasterDataIndex: IGdiMasterDataIndex = sampleWithRequiredData;
        const gdiMasterDataIndex2: IGdiMasterDataIndex = sampleWithPartialData;
    ...
    describe('compareGdiMasterDataIndex', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareGdiMasterDataIndex(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareGdiMasterDataIndex(entity1, entity2);
        const compareResult2 = service.compareGdiMasterDataIndex(entity2, entity1);
