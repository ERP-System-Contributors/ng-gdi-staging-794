...
import { FxTransactionTypeFormService, FxTransactionTypeFormGroup } from './fx-transaction-type-form.service';
...
export class FxTransactionTypeUpdateComponent implements OnInit {
  ...
  editForm: FxTransactionTypeFormGroup = this.fxTransactionTypeFormService.createFxTransactionTypeFormGroup();

  constructor(
    protected dataUtils: DataUtils,
    protected eventManager: EventManager,
    protected fxTransactionTypeService: FxTransactionTypeService,
    protected fxTransactionTypeFormService: FxTransactionTypeFormService,
  ...
  save(): void {
    this.isSaving = true;
    const fxTransactionType = this.fxTransactionTypeFormService.getFxTransactionType(this.editForm);
    if (fxTransactionType.id !== null) {
  ...
  protected updateForm(fxTransactionType: IFxTransactionType): void {
    this.fxTransactionType = fxTransactionType;
    this.fxTransactionTypeFormService.resetForm(this.editForm, fxTransactionType);
  }
}
