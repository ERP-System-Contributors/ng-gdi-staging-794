...
describe('CardTypes Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'card-types', component: CardTypesComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to cardTypesService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCardTypesIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCardTypesIdentifier).toHaveBeenCalledWith(entity);
