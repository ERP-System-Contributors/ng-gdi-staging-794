...
describe('CategoryOfSecurity routing resolve service', () => {
  ...
  let resultCategoryOfSecurity: ICategoryOfSecurity | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultCategoryOfSecurity).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ICategoryOfSecurity>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
