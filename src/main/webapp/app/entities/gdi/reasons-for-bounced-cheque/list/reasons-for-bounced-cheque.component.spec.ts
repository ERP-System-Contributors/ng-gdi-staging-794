...
describe('ReasonsForBouncedCheque Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'reasons-for-bounced-cheque', component: ReasonsForBouncedChequeComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to reasonsForBouncedChequeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getReasonsForBouncedChequeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getReasonsForBouncedChequeIdentifier).toHaveBeenCalledWith(entity);
