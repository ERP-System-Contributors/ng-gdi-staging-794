...
describe('AccountStatusType routing resolve service', () => {
  ...
  let resultAccountStatusType: IAccountStatusType | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultAccountStatusType).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IAccountStatusType>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
