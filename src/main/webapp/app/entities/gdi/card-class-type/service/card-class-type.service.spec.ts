...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../card-class-type.test-samples';

import { CardClassTypeService } from './card-class-type.service';

const requireRestSample: ICardClassType = {
...
describe('CardClassType Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a CardClassType', () => {
      ...
      const cardClassType = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(cardClassType).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a CardClassType', () => {
      const cardClassType = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(cardClassType).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addCardClassTypeToCollectionIfMissing', () => {
      it('should add a CardClassType to an empty array', () => {
        const cardClassType: ICardClassType = sampleWithRequiredData;
      ...
      it("should add a CardClassType to an array that doesn't contain it", () => {
        const cardClassType: ICardClassType = sampleWithRequiredData;
        const cardClassTypeCollection: ICardClassType[] = [sampleWithPartialData];
        expectedResult = service.addCardClassTypeToCollectionIfMissing(cardClassTypeCollection, cardClassType);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(cardClassType);
      });
      ...
      it('should add only unique CardClassType to an array', () => {
        const cardClassTypeArray: ICardClassType[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const cardClassTypeCollection: ICardClassType[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const cardClassType: ICardClassType = sampleWithRequiredData;
        const cardClassType2: ICardClassType = sampleWithPartialData;
    ...
    describe('compareCardClassType', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareCardClassType(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareCardClassType(entity1, entity2);
        const compareResult2 = service.compareCardClassType(entity2, entity1);
