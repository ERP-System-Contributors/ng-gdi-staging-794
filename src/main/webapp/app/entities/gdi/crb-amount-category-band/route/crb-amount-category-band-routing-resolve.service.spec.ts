...
describe('CrbAmountCategoryBand routing resolve service', () => {
  ...
  let resultCrbAmountCategoryBand: ICrbAmountCategoryBand | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultCrbAmountCategoryBand).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ICrbAmountCategoryBand>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
