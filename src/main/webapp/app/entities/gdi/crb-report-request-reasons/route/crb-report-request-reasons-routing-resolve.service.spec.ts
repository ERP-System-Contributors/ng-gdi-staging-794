...
describe('CrbReportRequestReasons routing resolve service', () => {
  ...
  let resultCrbReportRequestReasons: ICrbReportRequestReasons | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultCrbReportRequestReasons).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ICrbReportRequestReasons>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
