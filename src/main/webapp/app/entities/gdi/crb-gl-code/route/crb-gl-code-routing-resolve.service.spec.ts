...
describe('CrbGlCode routing resolve service', () => {
  ...
  let resultCrbGlCode: ICrbGlCode | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultCrbGlCode).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ICrbGlCode>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
