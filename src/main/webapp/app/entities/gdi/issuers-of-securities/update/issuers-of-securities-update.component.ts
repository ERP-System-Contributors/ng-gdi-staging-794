...
import { IssuersOfSecuritiesFormService, IssuersOfSecuritiesFormGroup } from './issuers-of-securities-form.service';
...
export class IssuersOfSecuritiesUpdateComponent implements OnInit {
  ...
  editForm: IssuersOfSecuritiesFormGroup = this.issuersOfSecuritiesFormService.createIssuersOfSecuritiesFormGroup();

  constructor(
    protected dataUtils: DataUtils,
    protected eventManager: EventManager,
    protected issuersOfSecuritiesService: IssuersOfSecuritiesService,
    protected issuersOfSecuritiesFormService: IssuersOfSecuritiesFormService,
  ...
  save(): void {
    this.isSaving = true;
    const issuersOfSecurities = this.issuersOfSecuritiesFormService.getIssuersOfSecurities(this.editForm);
    if (issuersOfSecurities.id !== null) {
  ...
  protected updateForm(issuersOfSecurities: IIssuersOfSecurities): void {
    this.issuersOfSecurities = issuersOfSecurities;
    this.issuersOfSecuritiesFormService.resetForm(this.editForm, issuersOfSecurities);
  }
}
