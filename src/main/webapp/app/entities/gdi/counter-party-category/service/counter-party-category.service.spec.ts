...
import {
  ...
  sampleWithFullData,
} from '../counter-party-category.test-samples';

import { CounterPartyCategoryService } from './counter-party-category.service';

const requireRestSample: ICounterPartyCategory = {
  ...sampleWithRequiredData,
};
...
describe('CounterPartyCategory Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a CounterPartyCategory', () => {
      ...
      const counterPartyCategory = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(counterPartyCategory).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a CounterPartyCategory', () => {
      const counterPartyCategory = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(counterPartyCategory).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addCounterPartyCategoryToCollectionIfMissing', () => {
      it('should add a CounterPartyCategory to an empty array', () => {
        const counterPartyCategory: ICounterPartyCategory = sampleWithRequiredData;
      ...
      it("should add a CounterPartyCategory to an array that doesn't contain it", () => {
        const counterPartyCategory: ICounterPartyCategory = sampleWithRequiredData;
        const counterPartyCategoryCollection: ICounterPartyCategory[] = [sampleWithPartialData];
        expectedResult = service.addCounterPartyCategoryToCollectionIfMissing(counterPartyCategoryCollection, counterPartyCategory);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(counterPartyCategory);
      });
      ...
      it('should add only unique CounterPartyCategory to an array', () => {
        const counterPartyCategoryArray: ICounterPartyCategory[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const counterPartyCategoryCollection: ICounterPartyCategory[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const counterPartyCategory: ICounterPartyCategory = sampleWithRequiredData;
        const counterPartyCategory2: ICounterPartyCategory = sampleWithPartialData;
    ...
    describe('compareCounterPartyCategory', () => {
      it('Should return true if both entities are null', () => {
        const entity1 = null;
        const entity2 = null;

        const compareResult = service.compareCounterPartyCategory(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareCounterPartyCategory(entity1, entity2);
        const compareResult2 = service.compareCounterPartyCategory(entity2, entity1);
