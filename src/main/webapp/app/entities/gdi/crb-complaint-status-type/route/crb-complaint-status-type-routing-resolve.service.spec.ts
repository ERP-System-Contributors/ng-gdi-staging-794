...
describe('CrbComplaintStatusType routing resolve service', () => {
  ...
  let resultCrbComplaintStatusType: ICrbComplaintStatusType | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultCrbComplaintStatusType).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ICrbComplaintStatusType>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
