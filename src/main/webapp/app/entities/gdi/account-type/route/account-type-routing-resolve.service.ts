...
export class AccountTypeRoutingResolveService implements Resolve<IAccountType | null> {
  constructor(protected service: AccountTypeService, protected router: Router) {}

  resolve(route: ActivatedRouteSnapshot): Observable<IAccountType | null | never> {
