...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../collateral-type.test-samples';

import { CollateralTypeService } from './collateral-type.service';

const requireRestSample: ICollateralType = {
...
describe('CollateralType Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a CollateralType', () => {
      ...
      const collateralType = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(collateralType).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a CollateralType', () => {
      const collateralType = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(collateralType).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addCollateralTypeToCollectionIfMissing', () => {
      it('should add a CollateralType to an empty array', () => {
        const collateralType: ICollateralType = sampleWithRequiredData;
      ...
      it("should add a CollateralType to an array that doesn't contain it", () => {
        const collateralType: ICollateralType = sampleWithRequiredData;
        const collateralTypeCollection: ICollateralType[] = [sampleWithPartialData];
        expectedResult = service.addCollateralTypeToCollectionIfMissing(collateralTypeCollection, collateralType);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(collateralType);
      });
      ...
      it('should add only unique CollateralType to an array', () => {
        const collateralTypeArray: ICollateralType[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const collateralTypeCollection: ICollateralType[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const collateralType: ICollateralType = sampleWithRequiredData;
        const collateralType2: ICollateralType = sampleWithPartialData;
    ...
    describe('compareCollateralType', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareCollateralType(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareCollateralType(entity1, entity2);
        const compareResult2 = service.compareCollateralType(entity2, entity1);
