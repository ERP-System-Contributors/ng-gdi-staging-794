...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../employment-terms.test-samples';

import { EmploymentTermsService } from './employment-terms.service';

const requireRestSample: IEmploymentTerms = {
...
describe('EmploymentTerms Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a EmploymentTerms', () => {
      ...
      const employmentTerms = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(employmentTerms).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a EmploymentTerms', () => {
      const employmentTerms = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(employmentTerms).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addEmploymentTermsToCollectionIfMissing', () => {
      it('should add a EmploymentTerms to an empty array', () => {
        const employmentTerms: IEmploymentTerms = sampleWithRequiredData;
      ...
      it("should add a EmploymentTerms to an array that doesn't contain it", () => {
        const employmentTerms: IEmploymentTerms = sampleWithRequiredData;
        const employmentTermsCollection: IEmploymentTerms[] = [sampleWithPartialData];
        expectedResult = service.addEmploymentTermsToCollectionIfMissing(employmentTermsCollection, employmentTerms);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(employmentTerms);
      });
      ...
      it('should add only unique EmploymentTerms to an array', () => {
        const employmentTermsArray: IEmploymentTerms[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const employmentTermsCollection: IEmploymentTerms[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const employmentTerms: IEmploymentTerms = sampleWithRequiredData;
        const employmentTerms2: IEmploymentTerms = sampleWithPartialData;
    ...
    describe('compareEmploymentTerms', () => {
      it('Should return true if both entities are null', () => {
        const entity1 = null;
        const entity2 = null;

        const compareResult = service.compareEmploymentTerms(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareEmploymentTerms(entity1, entity2);
        const compareResult2 = service.compareEmploymentTerms(entity2, entity1);
