...
describe('LegalStatus routing resolve service', () => {
  ...
  let resultLegalStatus: ILegalStatus | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultLegalStatus).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ILegalStatus>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
