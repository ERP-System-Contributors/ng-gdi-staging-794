...
describe('TerminalFunctions routing resolve service', () => {
  ...
  let resultTerminalFunctions: ITerminalFunctions | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultTerminalFunctions).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ITerminalFunctions>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
