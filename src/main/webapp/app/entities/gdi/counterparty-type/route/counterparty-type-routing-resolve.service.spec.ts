...
describe('CounterpartyType routing resolve service', () => {
  ...
  let resultCounterpartyType: ICounterpartyType | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultCounterpartyType).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ICounterpartyType>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
