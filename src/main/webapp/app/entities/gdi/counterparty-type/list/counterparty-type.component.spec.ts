...
describe('CounterpartyType Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'counterparty-type', component: CounterpartyTypeComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to counterpartyTypeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCounterpartyTypeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCounterpartyTypeIdentifier).toHaveBeenCalledWith(entity);
