...
describe('ProfessionalQualification routing resolve service', () => {
  ...
  let resultProfessionalQualification: IProfessionalQualification | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultProfessionalQualification).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IProfessionalQualification>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
