...
describe('CrbCustomerType Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'crb-customer-type', component: CrbCustomerTypeComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to crbCustomerTypeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCrbCustomerTypeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCrbCustomerTypeIdentifier).toHaveBeenCalledWith(entity);
