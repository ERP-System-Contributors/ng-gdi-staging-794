...
describe('ContractStatus routing resolve service', () => {
  ...
  let resultContractStatus: IContractStatus | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultContractStatus).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IContractStatus>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
