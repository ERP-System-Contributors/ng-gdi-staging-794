...
describe('CardCharges routing resolve service', () => {
  ...
  let resultCardCharges: ICardCharges | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultCardCharges).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ICardCharges>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
