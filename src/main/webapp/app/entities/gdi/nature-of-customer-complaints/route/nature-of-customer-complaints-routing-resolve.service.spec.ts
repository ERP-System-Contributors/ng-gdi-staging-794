...
describe('NatureOfCustomerComplaints routing resolve service', () => {
  ...
  let resultNatureOfCustomerComplaints: INatureOfCustomerComplaints | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultNatureOfCustomerComplaints).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<INatureOfCustomerComplaints>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
