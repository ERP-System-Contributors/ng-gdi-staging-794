...
describe('SecurityType routing resolve service', () => {
  ...
  let resultSecurityType: ISecurityType | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultSecurityType).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ISecurityType>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
