...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../weekly-cash-holding.test-samples';

import { WeeklyCashHoldingService, RestWeeklyCashHolding } from './weekly-cash-holding.service';

const requireRestSample: RestWeeklyCashHolding = {
...
describe('WeeklyCashHolding Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a WeeklyCashHolding', () => {
      ...
      const weeklyCashHolding = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(weeklyCashHolding).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a WeeklyCashHolding', () => {
      const weeklyCashHolding = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(weeklyCashHolding).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addWeeklyCashHoldingToCollectionIfMissing', () => {
      it('should add a WeeklyCashHolding to an empty array', () => {
        const weeklyCashHolding: IWeeklyCashHolding = sampleWithRequiredData;
      ...
      it("should add a WeeklyCashHolding to an array that doesn't contain it", () => {
        const weeklyCashHolding: IWeeklyCashHolding = sampleWithRequiredData;
        const weeklyCashHoldingCollection: IWeeklyCashHolding[] = [sampleWithPartialData];
        expectedResult = service.addWeeklyCashHoldingToCollectionIfMissing(weeklyCashHoldingCollection, weeklyCashHolding);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(weeklyCashHolding);
      });
      ...
      it('should add only unique WeeklyCashHolding to an array', () => {
        const weeklyCashHoldingArray: IWeeklyCashHolding[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const weeklyCashHoldingCollection: IWeeklyCashHolding[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const weeklyCashHolding: IWeeklyCashHolding = sampleWithRequiredData;
        const weeklyCashHolding2: IWeeklyCashHolding = sampleWithPartialData;
    ...
    describe('compareWeeklyCashHolding', () => {
      it('Should return true if both entities are null', () => {
        const entity1 = null;
        const entity2 = null;

        const compareResult = service.compareWeeklyCashHolding(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareWeeklyCashHolding(entity1, entity2);
        const compareResult2 = service.compareWeeklyCashHolding(entity2, entity1);
