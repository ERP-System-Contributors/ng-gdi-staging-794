...
import { EntityArrayResponseType, CardUsageInformationService } from '../service/card-usage-information.service';
...
export class CardUsageInformationComponent implements OnInit {
  ...
  trackId = (_index: number, item: ICardUsageInformation): number =>
    this.cardUsageInformationService.getCardUsageInformationIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.cardUsageInformations = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ICardUsageInformation[] | null): ICardUsageInformation[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    if (this.currentSearch && this.currentSearch !== '') {
      return this.cardUsageInformationService.search(queryObject).pipe(tap(() => (this.isLoading = false)));
    } else {
      return this.cardUsageInformationService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
    }
  }
