...
describe('CardUsageInformation routing resolve service', () => {
  ...
  let resultCardUsageInformation: ICardUsageInformation | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultCardUsageInformation).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ICardUsageInformation>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
