...
export class AgentBankingActivityRoutingResolveService implements Resolve<IAgentBankingActivity | null> {
  constructor(protected service: AgentBankingActivityService, protected router: Router) {}

  resolve(route: ActivatedRouteSnapshot): Observable<IAgentBankingActivity | null | never> {
    const id = route.params['id'];
    if (id) {
      return this.service.find(id).pipe(
        mergeMap((agentBankingActivity: HttpResponse<IAgentBankingActivity>) => {
