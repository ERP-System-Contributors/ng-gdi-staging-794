...
describe('AccountBalance Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'account-balance', component: AccountBalanceComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to accountBalanceService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getAccountBalanceIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getAccountBalanceIdentifier).toHaveBeenCalledWith(entity);
