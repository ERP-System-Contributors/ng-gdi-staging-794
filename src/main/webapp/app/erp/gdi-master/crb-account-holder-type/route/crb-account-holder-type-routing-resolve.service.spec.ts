...
describe('CrbAccountHolderType routing resolve service', () => {
  ...
  let resultCrbAccountHolderType: ICrbAccountHolderType | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultCrbAccountHolderType).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ICrbAccountHolderType>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
