...
describe('InstitutionStatusType routing resolve service', () => {
  ...
  let resultInstitutionStatusType: IInstitutionStatusType | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultInstitutionStatusType).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IInstitutionStatusType>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
