...
describe('InterbankSectorCode routing resolve service', () => {
  ...
  let resultInterbankSectorCode: IInterbankSectorCode | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultInterbankSectorCode).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IInterbankSectorCode>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
