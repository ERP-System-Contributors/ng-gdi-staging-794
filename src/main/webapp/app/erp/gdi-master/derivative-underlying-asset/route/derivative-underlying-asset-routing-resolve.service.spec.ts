...
describe('DerivativeUnderlyingAsset routing resolve service', () => {
  ...
  let resultDerivativeUnderlyingAsset: IDerivativeUnderlyingAsset | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultDerivativeUnderlyingAsset).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IDerivativeUnderlyingAsset>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
