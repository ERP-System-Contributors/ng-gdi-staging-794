...
describe('CurrencyServiceabilityFlag routing resolve service', () => {
  ...
  let resultCurrencyServiceabilityFlag: ICurrencyServiceabilityFlag | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultCurrencyServiceabilityFlag).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ICurrencyServiceabilityFlag>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
