...
describe('LoanRestructureItem routing resolve service', () => {
  ...
  let resultLoanRestructureItem: ILoanRestructureItem | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultLoanRestructureItem).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ILoanRestructureItem>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
