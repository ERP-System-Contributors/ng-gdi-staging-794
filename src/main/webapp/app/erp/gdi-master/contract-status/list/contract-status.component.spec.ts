...
describe('ContractStatus Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'contract-status', component: ContractStatusComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to contractStatusService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getContractStatusIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getContractStatusIdentifier).toHaveBeenCalledWith(entity);
