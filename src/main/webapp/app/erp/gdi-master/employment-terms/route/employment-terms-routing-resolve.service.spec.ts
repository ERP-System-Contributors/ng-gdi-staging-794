...
describe('EmploymentTerms routing resolve service', () => {
  ...
  let resultEmploymentTerms: IEmploymentTerms | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultEmploymentTerms).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IEmploymentTerms>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
