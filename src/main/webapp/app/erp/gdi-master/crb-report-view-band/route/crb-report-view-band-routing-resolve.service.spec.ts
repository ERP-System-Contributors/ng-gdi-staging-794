...
describe('CrbReportViewBand routing resolve service', () => {
  ...
  let resultCrbReportViewBand: ICrbReportViewBand | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultCrbReportViewBand).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ICrbReportViewBand>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
