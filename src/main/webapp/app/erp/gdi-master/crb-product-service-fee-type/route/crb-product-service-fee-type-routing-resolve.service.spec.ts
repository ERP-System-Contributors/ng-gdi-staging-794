...
describe('CrbProductServiceFeeType routing resolve service', () => {
  ...
  let resultCrbProductServiceFeeType: ICrbProductServiceFeeType | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultCrbProductServiceFeeType).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ICrbProductServiceFeeType>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
