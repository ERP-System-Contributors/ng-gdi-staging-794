...
describe('InstitutionContactDetails routing resolve service', () => {
  ...
  let resultInstitutionContactDetails: IInstitutionContactDetails | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultInstitutionContactDetails).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IInstitutionContactDetails>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
