...
describe('InsiderCategoryTypes routing resolve service', () => {
  ...
  let resultInsiderCategoryTypes: IInsiderCategoryTypes | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultInsiderCategoryTypes).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IInsiderCategoryTypes>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
