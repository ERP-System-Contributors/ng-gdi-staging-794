...
describe('ChannelType routing resolve service', () => {
  ...
  let resultChannelType: IChannelType | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultChannelType).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IChannelType>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
