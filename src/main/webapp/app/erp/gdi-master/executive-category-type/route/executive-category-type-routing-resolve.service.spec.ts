...
describe('ExecutiveCategoryType routing resolve service', () => {
  ...
  let resultExecutiveCategoryType: IExecutiveCategoryType | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultExecutiveCategoryType).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IExecutiveCategoryType>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
