...
describe('InterestCalcMethod routing resolve service', () => {
  ...
  let resultInterestCalcMethod: IInterestCalcMethod | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultInterestCalcMethod).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IInterestCalcMethod>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
