...
describe('AgriculturalEnterpriseActivityType routing resolve service', () => {
  ...
  let resultAgriculturalEnterpriseActivityType: IAgriculturalEnterpriseActivityType | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultAgriculturalEnterpriseActivityType).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IAgriculturalEnterpriseActivityType>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
