...
describe('SourceRemittancePurposeType routing resolve service', () => {
  ...
  let resultSourceRemittancePurposeType: ISourceRemittancePurposeType | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultSourceRemittancePurposeType).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ISourceRemittancePurposeType>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
