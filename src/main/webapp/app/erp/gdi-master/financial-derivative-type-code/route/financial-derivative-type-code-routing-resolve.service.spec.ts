...
describe('FinancialDerivativeTypeCode routing resolve service', () => {
  ...
  let resultFinancialDerivativeTypeCode: IFinancialDerivativeTypeCode | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultFinancialDerivativeTypeCode).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IFinancialDerivativeTypeCode>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
