...
describe('FraudCategoryFlag routing resolve service', () => {
  ...
  let resultFraudCategoryFlag: IFraudCategoryFlag | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultFraudCategoryFlag).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IFraudCategoryFlag>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
