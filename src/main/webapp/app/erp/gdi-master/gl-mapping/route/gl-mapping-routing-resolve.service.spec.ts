...
describe('GlMapping routing resolve service', () => {
  ...
  let resultGlMapping: IGlMapping | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultGlMapping).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IGlMapping>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
