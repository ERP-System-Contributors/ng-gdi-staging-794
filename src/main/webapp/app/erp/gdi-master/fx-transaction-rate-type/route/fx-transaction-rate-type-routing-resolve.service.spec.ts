...
describe('FxTransactionRateType routing resolve service', () => {
  ...
  let resultFxTransactionRateType: IFxTransactionRateType | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultFxTransactionRateType).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IFxTransactionRateType>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
