...
describe('GenderType routing resolve service', () => {
  ...
  let resultGenderType: IGenderType | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultGenderType).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IGenderType>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
