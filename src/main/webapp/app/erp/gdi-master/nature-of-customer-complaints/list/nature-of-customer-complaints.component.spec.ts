...
describe('NatureOfCustomerComplaints Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'nature-of-customer-complaints', component: NatureOfCustomerComplaintsComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to natureOfCustomerComplaintsService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getNatureOfCustomerComplaintsIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getNatureOfCustomerComplaintsIdentifier).toHaveBeenCalledWith(entity);
