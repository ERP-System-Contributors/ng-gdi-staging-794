...
describe('AccountOwnershipType routing resolve service', () => {
  ...
  let resultAccountOwnershipType: IAccountOwnershipType | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultAccountOwnershipType).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IAccountOwnershipType>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
