...
describe('CrbSubscriptionStatusTypeCode routing resolve service', () => {
  ...
  let resultCrbSubscriptionStatusTypeCode: ICrbSubscriptionStatusTypeCode | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultCrbSubscriptionStatusTypeCode).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ICrbSubscriptionStatusTypeCode>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
