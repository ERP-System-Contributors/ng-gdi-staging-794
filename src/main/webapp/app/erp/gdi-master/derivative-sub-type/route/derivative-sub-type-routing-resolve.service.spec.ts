...
describe('DerivativeSubType routing resolve service', () => {
  ...
  let resultDerivativeSubType: IDerivativeSubType | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultDerivativeSubType).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IDerivativeSubType>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
