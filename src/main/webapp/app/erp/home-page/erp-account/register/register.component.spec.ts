...
import { ErpRegisterComponent } from './erp-register.component';

describe('RegisterComponent', () => {
  let fixture: ComponentFixture<ErpRegisterComponent>;
  let comp: ErpRegisterComponent;

  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule],
      declarations: [ErpRegisterComponent],
      providers: [FormBuilder],
    })
      .overrideTemplate(ErpRegisterComponent, '')
      .compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(ErpRegisterComponent);
