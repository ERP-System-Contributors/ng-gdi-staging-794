...
import { ErpPasswordComponent } from './erp-password.component';
import { PasswordService } from './password.service';

describe('PasswordComponent', () => {
  let comp: ErpPasswordComponent;
  let fixture: ComponentFixture<ErpPasswordComponent>;
  let service: PasswordService;

  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule],
      declarations: [ErpPasswordComponent],
      providers: [FormBuilder, AccountService],
    })
      .overrideTemplate(ErpPasswordComponent, '')
      .compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(ErpPasswordComponent);
