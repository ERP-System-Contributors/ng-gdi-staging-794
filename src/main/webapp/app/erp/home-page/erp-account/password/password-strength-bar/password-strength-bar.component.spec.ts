...
import { ErpPasswordStrengthBarComponent } from './erp-password-strength-bar.component';

describe('PasswordStrengthBarComponent', () => {
  let comp: ErpPasswordStrengthBarComponent;
  let fixture: ComponentFixture<ErpPasswordStrengthBarComponent>;

  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [ErpPasswordStrengthBarComponent],
    })
      .overrideTemplate(ErpPasswordStrengthBarComponent, '')
      .compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(ErpPasswordStrengthBarComponent);
