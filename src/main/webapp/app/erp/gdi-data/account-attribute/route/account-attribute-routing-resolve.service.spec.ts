...
describe('AccountAttribute routing resolve service', () => {
  ...
  let resultAccountAttribute: IAccountAttribute | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultAccountAttribute).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IAccountAttribute>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
