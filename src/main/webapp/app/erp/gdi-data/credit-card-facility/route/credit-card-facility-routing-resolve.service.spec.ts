...
describe('CreditCardFacility routing resolve service', () => {
  ...
  let resultCreditCardFacility: ICreditCardFacility | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultCreditCardFacility).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ICreditCardFacility>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
