...
describe('AccountAttributeMetadata routing resolve service', () => {
  ...
  let resultAccountAttributeMetadata: IAccountAttributeMetadata | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultAccountAttributeMetadata).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IAccountAttributeMetadata>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
