...
describe('RelatedPartyRelationship routing resolve service', () => {
  ...
  let resultRelatedPartyRelationship: IRelatedPartyRelationship | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultRelatedPartyRelationship).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IRelatedPartyRelationship>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
