...
describe('WeeklyCashHolding routing resolve service', () => {
  ...
  let resultWeeklyCashHolding: IWeeklyCashHolding | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultWeeklyCashHolding).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IWeeklyCashHolding>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
